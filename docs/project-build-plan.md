...
| Working MVP | Built and measured, with a web interface (`python -m ai_prescan.web`). Live research path runs end to end (`--live`). n8n delivery to Notion is built and verified (`workflows/`); scheduled sweeps remain intent |
