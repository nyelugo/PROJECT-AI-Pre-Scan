...
| [`eval/results.md`](eval/results.md) | Measured results against target — what passes, what misses, and why |
| [`samples/`](samples/) | Two sample reports generated by the system, unedited |
